...
{/*
  ...
  The DX audit found 3 broken code blocks on this page: two blocks 404 against the SDK actually served by `pip install hydradb-sdk`, and one assigns into a `RetrievalResult`, which does not support item assignment.
