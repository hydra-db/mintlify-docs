...
\[todo\]: introduce concepts regarding webhook to check status - right now we tell users to poll. one line on how to use webhooks followed by a clear code example. 
