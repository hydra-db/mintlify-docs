...
| `tenant_id` | HydraDB's **internal** identifier for the database — not the name you ingested into. Always present. |
...
`tenant_id` is the internal identifier for that database and is not the name you
sent. See the [v2 webhooks payload](/essentials/v2/webhooks#payload) for the full
field list.
</Note>
