...
- **Remote MCP server** - point your client at the hosted URL `https://mcp.hydradb.com/mcp`. Nothing to install or update; you authenticate per request with headers.
  ...
  <Step title="Connect your client">
    <Tabs>
      <Tab title="Remote MCP server">
        Point your client at `https://mcp.hydradb.com/mcp` and pass your
