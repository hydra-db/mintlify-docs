...
| `sub_tenant_id` | Optional partition inside a database, often a user, team, account, or customer. | Use it when one database contains data for multiple users or customers. Read more about our [multi-database architecture](/essentials/v2/multi-tenant) |
