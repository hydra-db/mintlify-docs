...
- `pip install "hydradb-sdk>=2,<3" openai`
...
3. **The HydraDB SDK.** Run `pip install "hydradb-sdk>=2,<3" python-dotenv`.
...
```bash
pip install fastapi "uvicorn[standard]" openai python-dotenv "hydradb-sdk>=2,<3"
```
