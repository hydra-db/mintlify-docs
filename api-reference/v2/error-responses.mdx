...
Retry only transient failures: `429`, `500`, and `503`. Use exponential backoff with jitter and keep retries bounded. For `429` specifically, see [Rate Limits and Backoff](/essentials/v2/rate-limits) for how to design bulk traffic so you hit it less often.
