...
| `database` | Which database receives the synced data (deprecated alias: `tenant_id`) |
| `collection` | Default collection partition for synced objects (deprecated alias: `sub_tenant_id`) |
    ...
    "resources": [
      {
        ...
        "name": "general",
        "collection": "all-hands",     // deprecated alias: sub_tenant_id
      ...
      },
      {
        ...
        "resource_type": "channel",
        "name": "engineering",
        "collection": "engineering",   // deprecated alias: sub_tenant_id
...
| Field | Purpose |
|---|---|
| `collection` | Routes objects from this resource into a specific collection partition (overrides the connector-level `collection`; deprecated alias: `sub_tenant_id`) |
