...
Use this endpoint to add new fields to a database's `database_metadata_schema` (formerly `tenant_metadata_schema`; the old name is still accepted as a deprecated alias).
