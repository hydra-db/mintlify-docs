...
| <Field name="database" type="string" required /> | Which tenant receives the synced data. |
| <Field name="collection" type="string" /> | Default sub-tenant partition for synced objects. Individual resources can override this. (default: `""`) |
