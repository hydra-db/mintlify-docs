...
{/*
  ...
  The DX audit found 2 broken code blocks on this page: `from hydra_db import HydraDBError` raises ImportError — HydraDBError is the TypeScript class name, and the Python SDK has no equivalent.
