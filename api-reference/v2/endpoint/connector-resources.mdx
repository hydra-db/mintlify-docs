...
<Note>
The response includes `tenant_id_override` and `sub_tenant_id_override` for backward compatibility. The canonical names are `database_override` and `collection_override`.
</Note>
