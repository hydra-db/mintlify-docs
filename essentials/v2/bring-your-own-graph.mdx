...
Bring Your Own Graph (BYOG) lets you read and write
[HydraDB's core graph database](https://github.com/hydra-db/hydradb) with
**Cypher** - fully hosted and autoscaling.
