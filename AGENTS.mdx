---
title: "AI agents integration guide"
description: "LLM-facing reference for building and navigating the current HydraDB docs, API, SDKs, and cookbooks."
---

### This exact page, which is more human readable, is also available as markdown at [https://docs.hydradb.com/AGENTS.md](https://docs.hydradb.com/AGENTS.md)
...
- Python methods and fields: snake\_case, e.g. `client.tenants.sub_tenants()`, `tenant_id`, `sub_tenant_id`, `page_size`, `query_by`.
