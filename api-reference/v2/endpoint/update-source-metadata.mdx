...
| Name | Description |
| --- | --- |
| <Field name="database" type="string" required /> | Owning tenant. |
| <Field name="collection" type="string" required /> | Sub-tenant that contains the source. This endpoint does not default it. |
...
| <Field name="database" type="string" /> | Public tenant ID. |
| <Field name="collection" type="string" /> | Sub-tenant that contained the source. |
