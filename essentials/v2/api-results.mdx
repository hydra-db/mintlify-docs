...
For a two-chunk knowledge query with `graph_context: true` and a declared [forceful relation](/essentials/v2/forceful-relations), `build_string` returns a string like:
