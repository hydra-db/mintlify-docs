...
def _upload_batch(batch: list, collection_name: str) -> list:
...
def search(
    question:     str,
    user_id:      str,
    collection_name: str   = None,   # restrict to "slack"|"docs"|"email"|"github" or omit for all
    ...
    return client.query(
        ...
        **(collection_name and {"collection": collection_name} or {}),
    )
