...
- [Bring Your Own Graph](/essentials/v2/bring-your-own-graph#2-without-cypher-attach-a-graph-at-ingest) - supply your own entities and relations instead of auto-extraction
