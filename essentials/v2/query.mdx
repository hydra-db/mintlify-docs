...
<Tip>
Not into code yet? The dashboard's [Query console](https://app.hydradb.com/query) runs the same `/query` endpoint interactively — tune parameters and trace retrieval before writing a line of code.
</Tip>
