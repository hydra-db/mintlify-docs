...
- [Context Architecture Playbook](/essentials/v2/context-architecture/index)  -  design production context systems (strategies, reference architectures, anti-patterns, checklist)
