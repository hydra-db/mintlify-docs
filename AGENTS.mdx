...
|---|---|---|
| **Cursor for Docs** | Ingest codebase, PRs, Slack; multi-hop reasoning | [Guide Link](/cookbooks/v2/cookbook-01-build-cursor-for-docs) |
| **Build your own Glean** | Enterprise workplace search across SaaS platforms | [Guide Link](/cookbooks/v2/glean-clone) |
| **Internal Search Perplexity** | Citations and answer synthesis over Confluence/Slack | [Guide Link](/cookbooks/v2/internal-search-perplexity) |
| **Customer Support Agent** | Personalizing help with user/plan-specific memory | [Guide Link](/cookbooks/v2/customer-support-agent) |
| **IT Support / Notion AI** | Relational reasoning across Notion and Slack threads | [Guide Link](/cookbooks/v2/cookbook-04-build-notion-ai) |
| **Financial Analyst** | Trend analysis, temporal metadata, precise citations | [Guide Link](/cookbooks/v2/cookbook-10-ai-financial-analyst) |
| **LinkedIn Recruiter** | Exact skill/experience matching and post-filtering | [Guide Link](/cookbooks/v2/ai-linkedin-recruiter) |
| **AI Travel Planner** | Collaborative planning using personalized context | [Guide Link](/cookbooks/v2/ai-travel-planner) |
| **AI Onboarding Agent** | Org charts, specifications, and meeting transcripts | [Guide Link](/cookbooks/v2/ai-onboarding-agent) |
| **Competitive Intelligence** | Competitor announcements, job listings, pricing | [Guide Link](/cookbooks/v2/competitive-intelligence-agent) |
| **Chief of Staff / Actions** | Function routing, task tracking, and planning | [Guide Link](/cookbooks/v2/ai-chief-of-staff) |
