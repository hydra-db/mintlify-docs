...
- **Low Latency:** Sub-200ms retrieval in text mode. Latency scales with retrieval depth: hybrid/fast queries land around 376-489ms, `alpha: "auto"` around 633ms, and thinking mode around 1.3-1.9s.
