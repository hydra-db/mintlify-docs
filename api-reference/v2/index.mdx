...
- **Authentication:** See [Authentication and API versioning](/api-reference/v2/authentication)
...
**Authentication:** See [Authentication and API versioning](/api-reference/v2/authentication) for API-key setup, REST headers, and authentication troubleshooting.
