...
| [`/databases/{database}/metadata-schema`](/api-reference/v2/endpoint/get-metadata-schema) | `GET` | `databases.get_metadata_schema` | Read declared metadata schema | You need to see which metadata fields a database has already declared. |
