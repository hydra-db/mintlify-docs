...
<Note>
  Still deciding between Knowledge, Memories, app sources, and connectors? Walk
  through [Which Primitive Do I Use?](/get-started/v2/choosing-primitives) before
  you write ingestion code.
</Note>
