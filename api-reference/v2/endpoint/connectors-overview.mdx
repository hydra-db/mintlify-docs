...
| --- | --- | --- |
| [`/connectors/providers`](/api-reference/v2/endpoint/list-providers) | `GET` | List supported providers, or inspect one provider's contract |
...
```text
GET  /connectors/providers           -> pick a provider, fetch its credential schema
