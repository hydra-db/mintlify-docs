...
<Warning>
  **Common mistake:** `row_count` from [Database Stats](/api-reference/v2/endpoint/database-stats) counts individual chunks, not documents. For distinct source or memory counts, use [List Documents](/api-reference/v2/endpoint/list-documents) and read `pagination.total` from the response.
</Warning>
...
<Tip>
  **Related Resources**
  ...
  - **Before this:** [Create Database](/api-reference/v2/endpoint/create-database) - kicks off provisioning
