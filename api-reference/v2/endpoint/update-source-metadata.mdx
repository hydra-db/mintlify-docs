...
openapi: "api-reference/v2/openapi.json PATCH /context/sources/{source_id}/metadata"
---
...
| Name | Description |
| --- | --- |
| <Field name="database" type="string" required /> | Owning database. |
| <Field name="collection" type="string" required /> | Collection that contains the source. This endpoint does not default it. |
...
| <Field name="database" type="string" /> | Public database ID. |
