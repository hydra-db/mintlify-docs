...
<Tip>
Before uploading, use the [Ingest Doctor](/cookbooks/v2/ingest-doctor) to validate the JSON-encoded multipart fields, same-request source IDs, and `graph_payload` integrity offline.
</Tip>
