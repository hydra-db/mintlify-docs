...
| `sub_tenant_id` | string | No | default | Sub-tenant scope. Maximum 128 characters. |
...
| `sub_tenant_id` | string | **Required.** Sub-tenant scope. Use `"default"` if not partitioning by user. Maximum 128 characters. |
