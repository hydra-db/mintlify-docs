...
| [`/databases/collections`](/api-reference/v2/endpoint/list-collections) | `GET` | `databases.collections` / `databases.collections` | List active collections | You partition data by user, team, customer, or account and need to inspect those partitions. |
