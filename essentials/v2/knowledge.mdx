...
When in doubt, ask "would a different user benefit from seeing this?"  -  if yes, Knowledge; if no, Memory. For a decision tree covering this and the other ingestion choices, see [Choosing Your Ingestion Path](/essentials/v2/ingestion-decision-guide).
