...
<Tip>
The dashboard's [Logs page](https://app.hydradb.com/logs) shows every ingestion run and its pipeline stages — often the fastest way to see where a document is.
</Tip>
