...
A query that **failed** still issues a `request_id`, and feedback on it is especially valuable — send it too.
...
| `feedback` | yes | What was right or wrong, up to 8000 chars |
