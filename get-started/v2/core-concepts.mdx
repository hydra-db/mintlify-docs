...
<Note>
  Know what the primitives are, but not which one to use for your data? See
  [Which Primitive Do I Use?](/get-started/v2/choosing-primitives) — a decision
  guide for Knowledge vs Memories, app sources vs connectors, and when to set
  `infer`.
</Note>
...
- [Which Primitive Do I Use?](/get-started/v2/choosing-primitives) - pick Knowledge, Memories, app sources, or connectors before you write ingestion code
