...
flowchart LR
  ...
  subgraph Ingestion[Ingestion Plane - async]
    ...
    style Graph fill:#b83d0d,stroke:#b83d0d,stroke-width:2px,color:#f8fafc,stroke-linecap:round
  end
  ...
  subgraph Retrieval[Retrieval Plane - sync]
    ...
    style ContextGraph fill:#b83d0d,stroke:#b83d0d,stroke-width:2px,color:#f8fafc,stroke-linecap:round
...
flowchart LR
  ...
  style Graph fill:#b83d0d,stroke:#b83d0d,stroke-width:2.5px,color:#f8fafc,stroke-linecap:round
