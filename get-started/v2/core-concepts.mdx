...
> A short overview of each primitive, with links to deeper [Concepts](/essentials/v2/architecture) pages. New to HydraDB? [The Developer Journey](/get-started/v2/developer-journey) connects all five into one mental model, with decision trees and a worked example.
...
- [The Developer Journey](/get-started/v2/developer-journey) - decision trees, common mistakes, and an end-to-end worked example
