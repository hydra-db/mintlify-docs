...
<Note>
  For the full decision path — including when to use app sources or connectors,
  and how to set `infer` — see
  [Which Primitive Do I Use?](/get-started/v2/choosing-primitives).
</Note>
