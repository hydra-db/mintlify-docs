...
If you're new to HydraDB, read [The Developer Journey](/get-started/v2/developer-journey) first - it connects every concept below into one mental model before you write any code. For a faster primer, [Core Concepts](/get-started/v2/core-concepts) covers the same five primitives in a five-minute pass. If you want the architecture-level story, see [Architecture](/essentials/v2/architecture).
