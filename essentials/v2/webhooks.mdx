...
<Info>
Webhook management endpoints use the same standard v2 `{ success, data, error, meta }` envelope as `/databases`, `/context/*`, and `/query`. The fields shown below (`registered`, `url`, `event_types`, etc.) live under `data`.
</Info>
