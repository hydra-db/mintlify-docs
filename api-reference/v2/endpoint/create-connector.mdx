...
Not sure how to obtain the credentials for your provider? The [Connector Setup Guides](/essentials/v2/connector-setup) walk through each provider's console, and [Preview Provider Resources](/api-reference/v2/endpoint/preview-connector-resources) validates a credential before you store it here.
