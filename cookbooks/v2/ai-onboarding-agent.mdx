...
> **Note**: All code in this guide uses the official HydraDB Python SDK. Install it with `pip install "hydradb-sdk>=2,<3"`. Base URL: `https://api.hydradb.com`. Get your API key at [app.hydradb.com](https://app.hydradb.com).
...
| Error | Cause | Fix |
|---|---|---|
| `ModuleNotFoundError: No module named 'hydra_db'` | SDK not installed or wrong package name | Run `pip install "hydradb-sdk>=2,<3"`. Import as `from hydra_db import HydraDB`. |
