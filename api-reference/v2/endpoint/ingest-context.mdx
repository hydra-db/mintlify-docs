...
<Accordion title="Knowledge documents - upload PDFs, DOCX, CSV, markdown, or text">
  ...
  | Field | Description |
  | --- | --- |
  | <Field name="id" type="string" /> | Optional context ID. If set, becomes the `id` for this document (use your app's document ID for parity). Maximum 100 characters. |
...
<Accordion title="App sources - index text from your workspace or personal apps">
  ...
  | Field | Description |
  | --- | --- |
  | <Field name="id" type="string" required /> | Context ID. Treated as the upsert key. Send an empty string to have one generated upstream. Maximum 100 characters. |
...
<Accordion title="3. User memories - store notes or infer user preferences">
  ...
  | Field | Description |
  | --- | --- |
  | <Field name="id" type="string" /> | Optional unique ID. Acts as the upsert key. Maximum 100 characters. (default=auto-generated) |
