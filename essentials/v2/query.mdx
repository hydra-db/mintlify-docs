...
| `query_forceful_relations` | boolean | Whether to fetch author-declared related sources ([Forceful Relations](/essentials/v2/forceful-relations)) into `additional_context`. **Only takes effect in** `mode: "thinking"`**.** Default: `true`. |
