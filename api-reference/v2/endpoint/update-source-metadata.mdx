...
```json Success
{
  ...
  "data": {
    ...
    "sub_tenant_id": "team_docs",    // deprecated — use `collection`
    "updated": true,
...
| <Field name="tenant_id" type="string" /> | Public tenant ID. (deprecated — use `database`) |
| <Field name="sub_tenant_id" type="string" /> | Sub-tenant that contained the source. (deprecated — use `collection`) |
