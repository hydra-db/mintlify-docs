...
description: "Add new tenant metadata schema fields after database creation."
---
...
| Name | Description |
| --- | --- |
| <Field name="database" type="string" required /> | Database whose metadata schema should be extended. |
...
Each `add_fields[]` item uses the same field shape as `tenant_metadata_schema` on [Create Database](/api-reference/v2/endpoint/create-database):
...
- [Create Database](/api-reference/v2/endpoint/create-database)
