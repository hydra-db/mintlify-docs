...
<Note>
  New to HydraDB? See [Knowledge vs. Memories vs. Infer](/get-started/v2/core-concepts#knowledge-vs-memories-vs-infer) for the one-page version of this decision before diving into ingestion details.
</Note>
