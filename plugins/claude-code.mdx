...
<Warning>
This plugin page documents the current Claude Code packaging, which still uses the v1 tenant / sub-tenant env model. For HydraDB **API v2** integrations, use `database` / `collection` and `POST /query` — see the [Agent Integration Guide](/AGENTS), [Memories (v2)](/essentials/v2/memories), and [Knowledge (v2)](/essentials/v2/knowledge).
</Warning>
...
| Value       | Behavior                                                               |
| ----------- | ---------------------------------------------------------------------- |
| `memory`    | **(default)** Recalls from [Memories](/essentials/v2/memories) only       |
| `knowledge` | Recalls from [Knowledge](/essentials/v2/knowledge) only                   |
...
| Value       | Behavior                                                                                               |
| ----------- | ------------------------------------------------------------------------------------------------------ |
| `memory`    | **(default)** Syncs workspace docs into [Memories](/essentials/v2/memories) using `infer`                 |
| `knowledge` | Syncs workspace docs into the [Knowledge](/essentials/v2/knowledge) base                                  |
