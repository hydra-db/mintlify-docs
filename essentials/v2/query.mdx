...
<Info>
  Getting an empty result and not sure why? [Troubleshooting Empty Results](/essentials/v2/troubleshooting) walks the causes in order, from unfinished indexing to store, scope, filter, and envelope mistakes.
</Info>
...
- [Troubleshooting Empty Results](/essentials/v2/troubleshooting)  -  why a query returns nothing, and how to fix it
