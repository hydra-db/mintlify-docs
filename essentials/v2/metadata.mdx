...
| `enable_analyzer` | boolean | Enables text analysis (tokenization) for BM25 search on this field. Relevant alongside `enable_sparse_embedding` for `VARCHAR` fields you search by keyword. |
