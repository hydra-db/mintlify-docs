...
- **`chunk_id`s are resolved for you by default** - HydraDB links each relation to the source's chunks server-side, so you normally never supply or see chunk ids. If you also [bring your own chunks](/essentials/v2/bring-your-own-chunks), a relation may set an optional `chunk_ids` array of **your own** chunk ids to map it to exactly those chunks and skip that search - see [Combining with BYOG](/essentials/v2/bring-your-own-chunks#5-combining-with-bring-your-own-graph).
...
- [Bring Your Own Chunks](/essentials/v2/bring-your-own-chunks) - supply your own chunks, and map relations to them with `chunk_ids`
