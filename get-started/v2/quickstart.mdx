...
<Steps>
  ...
  <Step title="Ingest Memory into the default collection and indexation confirmation">
    <CodeGroup>
...
This is the core HydraDB loop from the database creation to searching the generated graph-aware chunks; that can be ultimately passed forward to the agents. 
