...
This guide covers concepts, payload format, and receiver patterns. For exact request/response shapes of each management endpoint, see the [Webhooks API reference](/api-reference/v2/endpoint/webhooks-overview).
