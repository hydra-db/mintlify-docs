...
For step-by-step instructions on obtaining credentials from each provider's console (Slack, GitHub, Linear, Notion, Gmail) and validating them before you create a connector, see the [Connector Setup Guides](/essentials/v2/connector-setup).
