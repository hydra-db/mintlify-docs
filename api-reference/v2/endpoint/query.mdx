...
| <Field name="collection" type="string or null" /> | Single collection scope. Deprecated aliases `sub_tenant_id` / `sub_tenant_ids` are still accepted; prefer `collection` / `collections`. |
