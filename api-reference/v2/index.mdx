...
- **Tenant scoping.** Most tenant-scoped endpoints require a `tenant_id`. Many source and query endpoints also accept an optional `sub_tenant_id` for finer-grained scoping. If omitted, defaults to the resolved primary tenant ID.
