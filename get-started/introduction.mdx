...
%% Set all node text to off-white for readability
  ...
  style H fill:#1e293b,stroke:#b83d0d,stroke-width:2px,color:#f8fafc,stroke-linecap:round
  %% 'Graph Traversal' - Hydra Orange Highlight
  style G fill:#b83d0d,stroke:#b83d0d,stroke-width:2.5px,color:#0a0908,stroke-linecap:round
