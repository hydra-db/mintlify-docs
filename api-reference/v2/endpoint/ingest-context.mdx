...
| <Field name="context_category" type='"auto", "user_preference", "business_knowledge" or "decision_trace"' /> | What kind of context this is. You set it; nothing infers it, and a misspelling is a `400`. Returned as `enrichment.kind` (omitted for `auto`). (default=`"auto"`) |
