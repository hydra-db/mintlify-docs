...
flowchart TB
  ...
  classDef agent fill:#b83d0d,stroke:#d64d00,color:#0a0908,stroke-width:2px
  classDef recall fill:#2a1508,stroke:#b83d0d,color:#f8fafc,stroke-width:2px
  ...
  classDef response fill:#1e293b,stroke:#d64d00,color:#f8fafc,stroke-width:1.5px
