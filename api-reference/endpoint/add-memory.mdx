...
| `sub_tenant_id` | string | No | Sub-tenant scope. If omitted, the default sub-tenant is used. Maximum 128 characters. |
...
| `source_id` | string | auto | Unique identifier. Auto-generated if omitted. Maximum 100 characters. |
