---
title: "Core of HydraDB"
description: "A tour of the five primitives that make HydraDB."
---

The following table gives an overview. Continue reading to understand each primitive in depth.

| Primitive | Description |
| --- | --- |
| **Knowledge** | Complete working context of your organization - documents, markdowns, <br />knowledge from apps, etc |
| **Memories** | User preferences, inferred traits, likes/dislikes. Makes context <br />retrieval natively personalized. |
| **Querying** | How agents read context from HydraDB |
| **Multi tenancy** | Isolated workspaces with sub-tenant hierarchy for strict RBACs. <br />Think of a tenant as one enterprise, and sub-tenants as the smaller <br />spaces within it: individual users, projects, or isolated context stores. |
| **Metadata** | Filters to enrich your context graph. Also useful for deterministic retrievals. |
