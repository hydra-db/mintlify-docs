...
The SDKs send the same `context` array as a JSON string in a form field of the same name. See [Ingest context](/essentials/v2/ingest#1-one-call-for-text-and-conversations).
