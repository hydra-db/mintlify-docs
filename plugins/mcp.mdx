...
Every call goes through the generated [`@hydradb/sdk`](https://www.npmjs.com/package/@hydradb/sdk),
pinned to an exact version behind a thin hand-owned wrapper that owns scope
injection and error translation - so an SDK regeneration cannot change the tools
your agent sees.
