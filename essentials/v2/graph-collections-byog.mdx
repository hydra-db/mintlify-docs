...
sidebarTitle: "Graph Collections (Cypher)"
description: "BYOG - full Cypher access to graph collections you own end-to-end."
---

<Note>
  This page covers **BYOG graph collections** - standalone graphs you query directly with Cypher. If you want to supply your own entities and relations for a *document* during ingestion (skipping LLM extraction), see [Bring Your Own Graph](/essentials/v2/bring-your-own-graph) instead.
</Note>
