...
import V1Deprecation from '/snippets/v1-deprecation.mdx'
...
flowchart TB
  ...
  classDef agent fill:#FF571A,stroke:#FF8A54,color:#f8fafc,stroke-width:2px
  classDef recall fill:#CC4515,stroke:#FF571A,color:#f8fafc,stroke-width:2px
  ...
  classDef response fill:#1e293b,stroke:#FF8A54,color:#f8fafc,stroke-width:1.5px
