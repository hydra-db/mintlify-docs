...
| <Field name="sub_tenant_id" type="string" /> | Logical partition inside the tenant. Maximum 128 characters. (default=`""`  -  default sub-tenant) |
...
<Accordion title="App sources - index text from your workspace or personal apps">
  ...
  | <Field name="sub_tenant_id" type="string" required /> | Logical partition inside the tenant. Must match the form-level `sub_tenant_id`. Maximum 128 characters. |
